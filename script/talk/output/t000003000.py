...
def t000003000_x8(val1=5, val2=10, val3=12, val4=10, val5=12, actionbutton1=6000, flag4=6001, flag5=6000,
    ...
    while True:
        """State 2"""
        call = t000003000_x11(actionbutton1=actionbutton1, flag4=flag4, flag5=flag5, z4=z4, z5=z5, z6=z6)
        def WhilePaused():
...
def t000003000_x45():
    ...
    if GetEventFlag(4653) == 1:
        ...
        def WhilePaused():
            ...
            SetWorkValueIf(not GetWorkValue(1) > 1 and DoesPlayerHaveSpEffect(9604) == 1, 1, 1)
            RequestAnimationIf(GetWorkValue(1) > 1, 20002, -1)
            GiveSpEffectToPlayerIf(GetWorkValue(0) > 1, 9601)
            SetWorkValueIf(not GetWorkValue(0) > 1 and DoesSelfHaveSpEffect(9605) == 1, 0, 1)
            c5_121(GetWorkValue(1) > 1, 9602)
            SetWorkValueIf(GetWorkValue(0) > 1 and not DoesSelfHaveSpEffect(9605), 0, 0)
        def ExitPause():
            SetWorkValue(1, 0)
            SetWorkValue(0, 0)
