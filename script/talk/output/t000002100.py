...
def t000002100_1():
    ...
    while Loop('mainloop'):
        ...
        assert not GetEventFlag(f206()) and (GetEventFlag(2002) == 1 or GetEventFlag(60110) == 1)
        while True:
            """State 3"""
            call = t000002100_x3()
            if call.Done():
                ...
                if call.Done():
                    pass
                # eventflag:60110:shop:101802:Spirit Calling Bell
                elif GetEventFlag(f206()) == 1 or not (GetEventFlag(2002) == 1 or GetEventFlag(60110) == 1):
                    Continue('mainloop')
            # eventflag:60110:shop:101802:Spirit Calling Bell
            elif GetEventFlag(f206()) == 1 or not (GetEventFlag(2002) == 1 or GetEventFlag(60110) == 1):
                Continue('mainloop')
