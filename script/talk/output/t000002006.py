...
def t000002006_x5(val1=_, actionbutton1=_):
    ...
    while True:
        ...
        """State 5"""
        c1_122()
        call = t000002006_x12(actionbutton1=actionbutton1, flag1=6001, flag2=6000, flag3=6000, flag4=6000,
...
def t000002006_x10():
    ...
    if f208() == 801400:
        """State 3"""
        # goods:11004:Cerulean Crystal Tear
        assert t000002006_x9(z1=f209(f208()), goods1=11004, action1=13041100)
    elif f208() == 801500:
        """State 4"""
        assert t000002006_x9(z1=f209(f208()), goods1=11100, action1=13041110)
    elif f208() == 802400:
        """State 5"""
        assert t000002006_x9(z1=f209(f208()), goods1=11101, action1=13041120)
    elif f208() == 802500:
        """State 6"""
        assert t000002006_x9(z1=f209(f208()), goods1=11102, action1=13041130)
    elif f208() == 802600:
        """State 7"""
        assert t000002006_x9(z1=f209(f208()), goods1=11103, action1=13041140)
    else:
        """State 2"""
        pass
    """State 8"""
